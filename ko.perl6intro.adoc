...
* *Perl 6*: 테스트스위트(test suite)를 포함한 언어 명세이다.
...
* link:http://pl6anet.org[pl6anet] 블로그 수집기. Perl6에 초첨을 둔 블로그 글들을  Stay tuned by reading blog posts that focus on Perl 6.
